...
const Pagination = ({ currentPage, itemsPerPage, totalItems, paginate }: PaginationProps) => {
      ...
      <div className='hidden lg:flex'>
        {pageNumbers.map(number => (
          <a
            ...
            className={`items-center text-xxl mx-10 ${currentPage === number ? 'text-bold' : 'text-secondary-500'}`}
          >
            <h1>{number}</h1>
          </a>
        ))}
